...
import { Home, Layers, Trophy, User, LogOut, Heart, Flame, Star } from 'lucide-react';
...
const NAV = [
  ...
  { to: '/app/courses', icon: Layers, key: 'courses' },
...
export function StudentLayout() {
  ...
  return (
    <div className="relative min-h-screen w-full text-white" dir="rtl">
      {/* Desktop floating vertical nav pill — mirrors the mobile bottom bar style */}
      <aside
      ...
      {/* Main content — leave room on the start side (right in RTL) for the floating pill */}
      <main className="relative z-10 md:ms-[96px] md:me-4 pb-24 md:pb-10 pt-20 px-4 md:px-8 max-w-[1240px] mx-auto">
        <Outlet />
      </main>
      ...
      <nav
        ...
        style={{
          background:
            'linear-gradient(0deg, rgba(8,4,28,0.95) 0%, rgba(8,4,28,0.4) 100%)',
          backdropFilter: 'blur(18px)'
        }}
      >
        <div
